                ...
                <div class="header-main">
                    ...
                    <div class="head-right">
                        <div class="top-nav"> <span class="menu"> <img alt="" src="images/icon.png"/></span>
                            <ul class="res">
                                <li><a href="index.php"><span data-hover="Princiapl"> Principal </span></a></li>
                                <li><a class="active" href="equipo.php"> Equipo </a></li>
                                <li><a href="horario.php"><span data-hover="Horario"> Horario </span></a></li>
                                <li><a href="galeria.php"><span data-hover="Galería"> Galería </span></a></li>
                                <li><a href="ubicacion.php"><span data-hover="Ubicación"> Ubicación </span></a></li>
                ...
                <div class="footer-main">
                    <div class="footer-top">
                        ...
                        <div class="col-md-6 footer-news .col-md-offset-4">
                            ...
                            <h4>vualapolefitnesstudio@gmail.com</h4>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
