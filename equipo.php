                    ...
                    <div class="head-right">
                        <div class="top-nav"> <span class="menu"> <img alt="" src="images/icon.png"/></span>
                            <ul class="res">
                                ...
                                <li>
                                	<a class="active" href="equipo"> Equipo </a>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="recent-bottom">
                    <div class="col-md-12 recent-left">
                    	<h3>Nuestro Equipo</h3><hr>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-20">
                            <div class="row">
                                <div class="hidden-xs col-sm-6 col-md-6 col-lg-3">
                                    <img src="images/pizarro.jpg" class="img-responsive">
                                </div>
                                <div class="col-xs-12 col-sm-9 col-md-6 col-lg-7">
                                    <h3>Fernanda Pizarro Castro</h3><hr>
                                    <p align="justify">
                                        Directora de Vualá Pole Studio<br>
                                        Nivel Básico: Obtenido en Allegra Pole Dance con Ana Brito de Buenos Aires Pole Studio.<br>
                                        Nivel Intermedio - Avanzado: Alma Pole, Body & Soul, con Viviana Brown, Paloma Velasco y Ricardo Bustos.<br>
                                        Publicista
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-20">
                            <div class="row">
                                <div class="hidden-xs col-sm-6 col-md-6 col-lg-3">
                                    <img src="images/vargas.jpg" class="img-responsive">
                                </div>
                                <div class="col-xs-12 col-sm-9 col-md-6 col-lg-7">
                                    <h3>Alisson Vargas Caamaño</h3><hr>
                                    <p align="justify">
                                        Instructora nivel Básico - Intermedio - Avanzado<br>
                                        Avalada por Vuala Pole Studio<br>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-20">
                            <div class="row">
                                <div class="hidden-xs col-sm-6 col-md-6 col-lg-3">
                                    <img src="images/camargo.jpg" class="img-responsive">
                                </div>
                                <div class="col-xs-12 col-sm-9 col-md-6 col-lg-7">
                                    <h3>Fernanda Camargo Aragón</h3><hr>
                                    <p align="justify">
                                        Instructora nivel Básico - Intermedio<br>
                                        Avalada por Vuala Pole Studio<br>
                                        Profesora de Educación Física con Mención en Adulto Mayor
                                    </p>
                                </div>
                            </div>
                        </div>
