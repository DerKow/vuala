                    ...
                    <div class="head-right">
                        <div class="top-nav"> <span class="menu"> <img alt="" src="images/icon.png"/></span>
                            <ul class="res">
                                ...
                                <li>
                                    <a class="active" href="horario.php"> Horario </a>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="recent-bottom">
                    <div class="col-md-6 recent-left">
                        <h3>Horario</h3>
                        <hr>
                        <p>El local está abierto de lunes a viernes desde las 9:00 hasta las 20:00 PM, y los días sábado está abierto desde las 9:30 hasta las 15:30.</p>
                        <br>
                    </div>
