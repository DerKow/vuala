...
<html>
    <head>
        ...
        <title>Vuala Pole Studio - Horario</title>
                    ...
                    <div class="head-right">
                        <div class="top-nav"> <span class="menu"> <img alt="" src="images/icon.png"/></span>
                            <ul class="res">
                                ...
                                <li>
                                    <a class="active" href="horario"> Horario </a>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="recent-bottom">
                    <div class="col-md-6 recent-left">
                        <h3>Horario</h3>
                        <hr>
                        <p>El local está abierto de lunes a viernes desde las 9:00 hasta las 21:00 PM, y los días sábado está abierto desde las 9:30 hasta las 15:30.</p>
                        <br>
                    </div>
                    <div class="col-md-6 recent-right">
                        ...
                        <hr>
                        <ol>
                            <li><p>Matricula: $10.000</p></li>
                            <li><p>Mensualidad:</p>
                                <ul>
                                    <li><p>1 clase semanal: $20.000 mensual</p></li>
                                    <li><p>2 clase semanal: $30.000 mensual</p></li>
                                    <li><p>3 clase semanal: $40.000 mensual</p></li>
                                </ul>
                            </li>
                            <li><p>Curso de Flexibilidad:</p>
                                <ul>
                                    <li><p>1 clase semanal (alumnas no matriculadas): $20.000 mensual</p></li>
                                    <li><p>1 clase semanal (alumnas matriculadas con clases vigentes): $5.000 mensual</p></li>
                                </ul>
                            </li>
                        </ol>
                        <br>
