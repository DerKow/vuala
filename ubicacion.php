...
<html>
    <head>
        ...
        <title>Vuala Pole Studio - Ubicacion</title>
        ...
        <script type="text/javascript">
			var myCenter=new google.maps.LatLng(-29.905034,-71.24863);
			...
			function initialize(){
				...
				var infowindow = new google.maps.InfoWindow({
			  		content:"<p><b>Dirección: </b>Ohiggins 648 Segundo Piso, La Serena, Chile.<br><b>Horario: </b>Lunes a Viernes, de 9:00 a 21:00.<br><b>Teléfono: </b>+56 9 9330 3572<br><b>Correo: </b>contacto@vuala.cl</p>"
			  	});
                    ...
                    <div class="head-right">
                        <div class="top-nav"> <span class="menu"> <img alt="" src="images/icon.png"/></span>
                            <ul class="res">
                                ...
                                <li>
                                    <a class="active" href="ubicacion"> Ubicación </a>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="recent-bottom">
                    <div class="col-md-12 recent-left">
                        <h3>Dirección</h3>
                        <hr>
                        <p>El local esta ubicado en el segundo piso en la calle Libertador Bernardo O’Higgins 648 (Centro de Serena), La Serena.</p>
                        <br>
                    </div>
                    <div class="col-md-12 recent-left">
                        <h3>Mapa</h3>
